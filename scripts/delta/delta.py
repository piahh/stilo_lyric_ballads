...
def delta_attribution(path, prefix):
    for file in glob.glob(path):
        ...
        # print(attribution)
        attribution.to_hdf('/home/piah/Dokumente/Uni/Projektarbeit/Projektarbeit_LyrikGattungszuweisung/corpus/results/delta/autoren_gesamt.h5',  key='data', mode='w')


if __name__ == "__main__":
    path = '/home/piah/Dokumente/Uni/Projektarbeit/Projektarbeit_LyrikGattungszuweisung/corpus/results/delta/zscores_autoren_gesamt.csv'
